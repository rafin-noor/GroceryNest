...
const Cart = () => {
    const {products,currency,cartItems,removeFromCart,getcartcount,navigate,getcartamount,updateCartItem,axios,user,setCartItems} = useAppContext();
    ...
    return products.length>0 && cartItems? (
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                               {addresses.map((address, index) => (
                                ...
                                className="text-[var(--color-primary)] text-center cursor-pointer p-2 
                ...
                className="w-full py-3 mt-6 cursor-pointer bg-[var(--color-primary)] text-white font-medium 
